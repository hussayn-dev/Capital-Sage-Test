...
trait Bvn_VerificationTrait
{
    /**
     * @param string $phoneNumber
     * @return int | null
     */
    protected function sendOtp(string $phoneNumber) : int | null
    {
        try {
//              $otp = mt_rand(100000, 999999); // Generate a random 6-digit OTP
            $otp =  "555555";
              ...
              $response = send_post_request($url, $data , array(
   ...
   public function convertToInternationalFormat(string $phoneNumber): string
   {
    ...
    protected function get_details(string $user_id) : string | null
    {
        return Redis::hget("user_otp", $user_id);
    }
